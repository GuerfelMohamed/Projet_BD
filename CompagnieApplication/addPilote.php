    ...
    <section id="main" class="wrapper">
        <div class="inner">
            <div class="content">
                ...
                <h3 style="color:red; text-align: center;">Ajouter un nouveau pilote</h3>
                <form method="post">
                    <div class="row gtr-uniform">
                        ...
                        <div class="col-6 col-12-xsmall">
                            ...
                            <input type="text" name="salaire" id="salaire" value="" pattern="[0-9]+"
                                placeholder="salaire" />
                        </div>

                        <div class="col-6 col-12-xsmall">
                            <label style="text-align: left;">Nombre d'heures de vol :</label>
                            <input type="text" name="heureVol" id="heureVol" value="" pattern="[0-9]+"
                                placeholder="nombre d'heures de vol" />
                        </div>
                        <div class="col-12">
                            <label style="text-align: left;"><span style="color:red;">*</span>Numéro Sécurité sociale
                                :</label>
                            <input type="text" required="required" name="numSS" id="numSS" value="" pattern="[0-9]+"
                                placeholder="numéro sécurité sociale" />
                        </div>

                        <div class="col-12">
                            <label style="text-align: left;">Numéro de license :</label>
                            <input type="text" name="numLi" id="numLi" value="" pattern="[0-9]+"
                                placeholder=" Numéro License" />
                        </div>
                        <div>
                            <ul class="actions">
