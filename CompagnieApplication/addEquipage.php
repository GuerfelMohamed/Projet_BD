...
<head>
	...
	<title>Ajout d'un membre d'équipage</title>
...
if (!$res=$mysqli->multi_query("CALL ajouter_membre($numSS,'$fonction',$heureVol,'$prenom','$nom','$adresse',$salaire)")) {
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.php">Accueil</a></li>
			<li class="active">Membre d'équipage</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Ajout Membre équipage</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Ajouter un nouveau membre d'équipage</h3>
							<hr>
