...
<head>
	...
	<title>Ajout d'un aéroport</title>
...
if (!$res=$mysqli->multi_query("CALL ajouter_aeroport('$nom','$code','$ville')")) {
														echo "Echec lors de l'appel à la procédure stockée : (" . $mysqli->errno . ") " . $mysqli->error;
													}
	header('location: http://db/CompagnieApplication/adminView.php');
}}
			?>
	<!-- Fixed navbar -->
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Ajout Aéroport</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Ajouter un nouveau Aéroport</h3>
							<hr>
							...
							<form  method="post">
								...
								<div class="top-margin">
									<label>Ville Aéroport<span class="text-danger">*</span></label>
