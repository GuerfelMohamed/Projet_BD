...
<head>
	...
	<title>Ajout d'une Liaison</title>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<form  method="post">
								...
								<div class="top-margin">
									<label>Nom Aéroport départ</label>
									<div class="select">
									<select name="nomD">
									<?php 
											$mysqli = new mysqli("db", "root", "root", "bd");
								...
								<div class="top-margin">
									<label>Code Aéroport Départ<span class="text-danger">*</span></label>
									<input type="date" name="codeD" class="form-control">
								</div>
								
								<div class="top-margin">
									<label>Nom Aéroport d'arrivée<span class="text-danger">*</span></label>
									<input type="time" name="nomA" class="form-control">
								</div>
								
								<div class="top-margin">
									<label>Code Aéroport d'arrivée<span class="text-danger">*</span></label>
									<input type="time" name="codeA" class="form-control">
								</div>
