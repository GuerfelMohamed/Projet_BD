...
Insert into Aeroports_departs select nom_aeroport from aeroport where ville=ville_depart;
Insert into Aeroports_destinations select nom_aeroport from aeroport where ville=ville_destination;
...
SET v=(select ville from aeroport where nom_aeroport=nom);
...
SET v1:=(select ville from aeroport where nom_aeroport=nom);
